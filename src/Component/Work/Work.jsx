...
function Work() {
  return (
    <section className='pt-32 pb-20 flex flex-col py-16 px-4 sm:px-10 lg:px-52 text-stone-50 bg-black dark:bg-stone-50 dark:text-neutral-900'>
      <h1 className='text-5xl font-bold pb-4'>Projects</h1>
      <p className='pb-10  text-neutral-600'>Projects and ideas I’ve worked on</p>
      {/* First Work Card */}
      <div className="bg-zinc-900 mb-8 flex flex-col lg:flex-row justify-between lg:items-center lg:gap-8 rounded-lg">
        <div className="card-body text-stone-50 bg-zinc-900 dark:bg-stone-50 dark:text-neutral-900 p-4 sm:p-8">
          ...
          <div className="card-actions justify-start mt-4">
            <a href="https://react.dev/">
              <button className="flex items-center gap-2 text-stone-50 bg-zinc-900 dark:bg-stone-50 dark:text-neutral-900 px-4 py-2 rounded-md">
        ...
        <div className='text-stone-50 bg-zinc-900 dark:bg-stone-50 dark:text-neutral-900'>
          <img className='w-full lg:w-[600px] h-[200px] lg:h-[324px] object-cover rounded-lg' src="https://i.ibb.co/JmXgVMk/react.jpg" alt="" />
        </div>
      </div>
      ...
      <div className="bg-zinc-900 mb-8 flex flex-col lg:flex-row justify-between lg:items-center lg:gap-8 rounded-lg">
        ...
        <div className='text-stone-50 bg-zinc-900 dark:bg-stone-50 dark:text-neutral-900'>
          <img className='w-full lg:w-[600px] h-[200px] lg:h-[348px] object-cover rounded-lg' src="https://i.ibb.co/WKcNT3f/62d8ab7014324b253e00f23f-what-is-next-js-p-500.jpg" alt="" />
        </div>
      </div>
      ...
      <div className="bg-zinc-900 mb-8 flex flex-col lg:flex-row justify-between lg:items-center lg:gap-8 rounded-lg">
        ...
        <div className='text-stone-50 bg-zinc-900 dark:bg-stone-50 dark:text-neutral-900'>
          <img className='w-full lg:w-[600px] h-[200px] lg:h-[420px] object-cover rounded-lg' src="https://i.ibb.co/hFLmR1P/9epc8m93yewqoix2318e.jpg" alt="" />
        </div>
      </div>
